...
public class SimpleChat {
	...
	public void start() throws Exception {
		...
		channel.getState(null, 10000); // sendMessage(); // channel.close(); }
										// private void sendMessage() throws
										// Exception { boolean succeed = false;
										// BufferedReader br = null; try { br =
										// new BufferedReader(new
										// InputStreamReader(System.in));
										// while(true) { System.out.print(">");
										// System.out.flush(); String line =
										// br.readLine(); if(line != null &&
										// line.equals("exit")) { break; } else
										// { Message msg = new Message(null,
										// null, "[" + userName + "]" + line);
										// channel.send(msg); } } succeed =
										// true; } finally { if(br != null) {
										// try { br.close(); } catch (Exception
										// e) { if(succeed) { throw e; } } } } }
